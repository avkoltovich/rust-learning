...
// TODO: 1. Получить строку 
// 2. Разложить на байты и вернуть вектор индексов пробелов
// 3. Из строки и вектора индексов нарезать и вернуть вектор слов.
// 4. Добавить работника в хэшмапу по ключу "отдел"